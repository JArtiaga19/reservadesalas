...
public class FechasInvalidasException extends RuntimeException {
    ...
    // Constructor por defecto con mensaje predefinido
    public FechasInvalidasException() {
        super("La fecha de inicio debe ser anterior a la fecha de fin");
    }

    // Constructor añadido para permitir mensajes personalizados
...
/*
 * Excepción personalizada que se lanza cuando las fechas de una reserva no son
 * válidas.
 *
 ...
 *
 * Forma parte de las validaciones implementadas en la capa de servicio y es
 * manejada globalmente por el controlador de excepciones (ControllerAdvice),
 * devolviendo un mensaje claro y un código de estado HTTP 400 al cliente.
 *
 * Su propósito es mantener la integridad de los datos y garantizar que las
 * reglas de negocio relacionadas con fechas se cumplan correctamente.
 */
